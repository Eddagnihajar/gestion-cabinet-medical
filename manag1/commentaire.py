...
# funtion to call submit button
    ...
    def updatee(self):
        ...
        self.id = Label(self.updateframe, text="Donnez le numéro de commentaire a modifier ", font=('arial 12 bold'),fg="red")
...
#buttons for update and delete
    ...
    def deletee(self):
            ...
            self.id = Label(self.deleteframe, text="Donnez le numéro du commentaire a supprimer ", font=('arial 12 bold'), fg="red")
            self.id.place(x=0, y=12)
